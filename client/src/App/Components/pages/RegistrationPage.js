            ...
            <div className="Registration-page">
                <div className="form" >
                    ...
                    <form className="Registration-form" >
                        ...
                        <input type="password" placeholder="Confirm Password"  id = "confirmedPassword" value ={this.state.confirmedPassword} onChange={this.handleChange}/>
